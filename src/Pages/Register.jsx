  ...
  return (
    <div className="flex h-screen justify-center items-center bg-[url(hotel.jpg)] bg-cover">
      <div className="p-6 border-4  border-white rounded-lg bg-gradient-to-br from-purple-500 ">
          ...
          <div className="flex space-x-1  items-center  ">
            <div>
              ...
              <input
                type="checkbox"
                name="password"
                className="mt-1 border-0 text-black"
              />
            </div>
        ...
        <button className=" border-1 w-full font-bold bg-green-500 text-white hover:bg-green-300 transition-all cursor-pointer rounded-full mt-2">
          Login
        </button>
        ...
        <p className=" pt-4 text-xs font-bold text-white text-center">
          Don't have an account ?{" "}
            ...
            <span className="font-bold text-blue-800 underline cursor-pointer hover:text-black transition-all">
              Register
            </span>
